...
int main(int argc, char* argv[])
{
	...
	if (bResult) {
		...
		if (bResult) {
			char *pTiger = /*_com_util::ConvertBSTRToString(stringResult)*/0;
	...
	if (bResult) {
		...
		char *pLion = /*_com_util::ConvertBSTRToString(stringResult)*/0;
	...
	if (bResult) {
		...
		char *pDot = /*_com_util::ConvertBSTRToString(stringResult)*/0;
