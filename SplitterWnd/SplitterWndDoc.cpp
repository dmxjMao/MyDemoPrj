...
void CSplitterWndDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CSplitterWndDoc::InitializeSearchContent()
{
...
void CSplitterWndDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
