...
// CChart0 wrapper class

class CChart0 : public COleDispatchDriver
{
public:
	CChart0() {} // Calls COleDispatchDriver default constructor
	CChart0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CChart0(const CChart0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	{
		BOOL result;
		InvokeHelper(0xcce, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_DisplayValueNotAvailableAsBlank(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcce, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
